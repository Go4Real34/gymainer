...
class ConvLTSMModel:
    ...
    def save(self):
        ...
        model_file_name = f"ConvLTSMModel_{date_string}__Accuracy_{accuracy}__Loss_{loss}"
        model_save_folder_path = os.path.join("models", "saves", "ConvLTSM")
        if not os.path.exists(model_save_folder_path):
            os.makedirs(model_save_folder_path)

        model_save_path = os.path.join(model_save_folder_path, (model_file_name + ".h5"))
        
        model_plot_folder = os.path.join("models", "plots", "ConvLTSM")
    ...
    def create_model(self):
        ...
        model.add(ConvLSTM2D(filters=self.all_settings.get_model_filter_count(1), 
                             ...
                             return_sequences=self.all_settings.get_model_return_sequence(1)))
        ...
        model.add(ConvLSTM2D(filters=self.all_settings.get_model_filter_count(2), 
                             ...
                             return_sequences=self.all_settings.get_model_return_sequence(2)))
        ...
        model.add(ConvLSTM2D(filters=self.all_settings.get_model_filter_count(3), 
                             ...
                             return_sequences=self.all_settings.get_model_return_sequence(3)))
